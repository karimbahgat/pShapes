...
class ResultsTable:
    def __init__(self):
        self.provs = []
        self.events = []
        self.maxdate = datetime.date(year=2015, month=1, day=1)
...
##                                None)
        ...
        #eventstable = eventstable.select(lambda f: not (f['fromcountry']=='Egypt' and f["date"] == "1950-01-01"))
        #eventstable = eventstable.select(lambda f: not (f['tocountry']=='Sierra Leone Protectorate' and f["date"] == "1920-01-01"))
